...
@Slf4j
public class ComplexProc implements ComplexProcessor {

    private OData odata;
    private Storage storage;
    private ServiceMetadata serviceMetadata;

    public ComplexProc(Storage storage) {
    ...
    @Override
    public void updateComplex(ODataRequest request, ODataResponse response, UriInfo uriInfo, ContentType requestFormat, ContentType
        responseFormat)
        throws ODataApplicationException, ODataLibraryException {
        throw new ODataApplicationException("somesome", 500, Locale.ENGLISH);
//        throw new UnsupportedOperationException("Update of complex property not yet supported");
    }

    @Override
    public void deleteComplex(ODataRequest request, ODataResponse response, UriInfo uriInfo) throws
        ODataApplicationException, ODataLibraryException {
        throw new ODataApplicationException("somesome", 500, Locale.ENGLISH);
//        throw new UnsupportedOperationException("Delete of complex property not yet supported");
    }
